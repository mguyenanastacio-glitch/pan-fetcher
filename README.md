...
内置多个 BT 索引器，Cardigann YAML 兼容可自行扩展。分类筛选、关键词过滤、分页浏览、一键订阅。搜索结果自动去重。
...
**Prebuilt binaries · All platforms:** [GitHub Releases](https://github.com/mguyenanastacio-glitch/pan-fetcher/releases)
...
**From source · All platforms:** `go build -ldflags="-s -w" -o pan-fetcher . && ./pan-fetcher server`
