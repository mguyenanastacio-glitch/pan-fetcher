...
func TestResolveCookiesFile_RelativePath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			cookiesFile: ".cookies",
			tomlPath:    "/home/user/.config/pan-fetcher/config.toml",
			want:        "/home/user/.config/pan-fetcher/.cookies",
		},
		{
			name:        "relative path with subdirectory",
			cookiesFile: "auth/.cookies",
			tomlPath:    "/home/user/.config/pan-fetcher/config.toml",
			want:        "/home/user/.config/pan-fetcher/auth/.cookies",
		},
		{
...
func TestResolveCookiesFile_AbsolutePath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			cookiesFile: "/etc/pan-fetcher/.cookies",
			tomlPath:    "/home/user/.config/pan-fetcher/config.toml",
			want:        "/etc/pan-fetcher/.cookies",
		},
		{
			name:        "absolute windows path",
			cookiesFile: "C:/Users/user/.cookies",
			tomlPath:    "C:/Users/user/.config/pan-fetcher/config.toml",
